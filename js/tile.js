define(["esri/layers/TiledMapServiceLayer", 'dojo/_base/declare', "esri/layers/TileInfo"], function (TiledMapServiceLayer, declare, TileInfo) {
    return declare(TiledMapServiceLayer, {
        ...
        getTileUrl: function (level, row, col) {
            {
                var tileUrl ='http://t0.tianditu.com/vec_c/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER=vec&STYLE=default&FORMAT=tiles&TILEMATRIXSET=c&TILEMATRIX='+level+'&TILEROW='+row+'&TILECOL='+col;
